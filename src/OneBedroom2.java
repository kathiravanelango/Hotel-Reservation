 ...
 * @author kathir
 */
public class OneBedroom2 extends javax.swing.JFrame {

    /**
     * Creates new form OneBedroom2
     */
    public OneBedroom2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Serviced Apartments - One Bedroom");
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 630, 90, 30));
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 630, -1, 30));
        ...
        jScrollPane3.setBounds(0, 0, 450, 680);

        setSize(new java.awt.Dimension(468, 729));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String rty= "Serviced Apartments-One Bedroom";
        //The below code is to convert java date to sql date.!!!
        ...
        int roomamount=15000*nroom*noofdays3;
        int inclu=0;
        ...
        try
        {
            ...
            String q = "insert into roombook values('"+name+"','"+rty+"','"+sqlDate1+"'"
            + ",'"+sqlDate2+"','"+nroom+"','"+totper+"','"+dining2+"','"+finalamount+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OneBedroom2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
