 ...
 * @author kathir
 */
public class Tanjore1 extends javax.swing.JFrame {

    /**
     * Creates new form Tanjore1
     */
    public Tanjore1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Boardrooms/conference rooms are often the showpiece of an \norganisation and the 91 sq mt Tanjore Boardroom is no \nexception- Stylish AV systems enhance the elegantly designed,\nmodern look of this boardroom/conference room, and its\neasy-to-use environment and presentation and entertainment \nsystems add to its comfort.");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 430, 430, 110));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 110, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TanjoreMeeting.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 400, 240));

        jDateChooser1.setDateFormatString("yyyy-MM-dd");
        jPanel1.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 600, 140, 30));

        jDateChooser2.setDateFormatString("yyyy-MM-dd");
        jPanel1.add(jDateChooser2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 600, 130, 30));

        jLabel4.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        jLabel4.setText("Enter Your Name : ");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 670, 130, 20));
        ...
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 640, -1, -1));

        jTextField2.setEditable(false);
        jTextField2.setBackground(new java.awt.Color(255, 255, 255));
        jTextField2.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        jTextField2.setText("Price : Rs.8000 per hour");
        jTextField2.setBorder(null);
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 540, 220, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 720, 120, -1));
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 670, 90, -1));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 480, 790));
        ...
        setSize(new java.awt.Dimension(507, 709));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ("jdbc:mysql://localhost:3306/katpro","root","123");
            Statement s=(Statement)con.createStatement();
            String q = "insert into meetevent values('"+name+"','"+mname+"',"
                    + "'"+sqlDate1+"','"+sqlDate2+"','"+time2+"','"+amt+"');";
            ...
            if(x>0)
            {
             ...
             this.dispose();
                ...
                JOptionPane.showMessageDialog(null,"Entry Not Acceptable! "
                        + "Change Your Book-in Name!");
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tanjore1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
